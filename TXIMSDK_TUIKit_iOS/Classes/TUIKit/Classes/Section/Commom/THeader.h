...
#define NSC_MainThemColor  HEXCOLOR(0x30302F)
#define NSC_BGThemColor2  HEXCOLOR(0x282828)
#define NSC_BGThemColor  HEXCOLOR(0x1F1F1F)
#define NSC_BGThemColor4  HEXCOLOR(0x323232)
...
#define NeighborsSimple_LoginStatus @"Nsc_loginstatus"
#define NeighborsSimple_OpenStatus @"Nsc_OpenStatus"
#define NeighborsSimple_ShowPageStatus @"Nsc_showpageStatus"
#define NeighborsSimple_Register @"Nsc_Register"
#define NeighborsSimple_account @"Nsc_account"
#define NeighborsSimple_pwd @"Nsc_pwd"
#define NeighborsSimpleEmailName  @"hooil@qq.com"
#define NeighborsSimpleEmailPwd  @"123456"
#define NeighborsSimple_EmailName @"UserEmail"
#define NeighborsSimple_EmailPwd @"UserPwd"
#define NeighborsSimple_EmailUser @"UserName"
#define NeighborsSimple_EmailGender @"UserGender"
#define NeighborsSimple_EmailAge @"UserAge"
#define NeighborsSimple_APPID @"1572665649"
#define NSC_Base_Url  @"http://www.shixiaoqinone.cn/fate/"
#define NeighborsSimple_Token @"userToken"
#define NeighborsSimple_LoginUser @"login_user"
#define NeighborsSimple_LoginPWd @"login_pwd"
